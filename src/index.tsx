...
import { ILineChartConfig, ILineChartOptions } from './interface';
...
export default class ScomLineChart extends ScomCharts<ILineChartOptions> implements ICustomWidget {
  ...
  getChartData() {
    ...
    return { chartData: _chartData, defaulBuildertData: configData.defaultBuilderData as ILineChartConfig };
  }
