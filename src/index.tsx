...
import { PageBlock, ILineChartConfig, callAPI, formatNumber, groupByCategory, extractUniqueTimes, concatUnique, groupArrayByKey, formatNumberByFormat } from './global/index';
...
export default class ScomLineChart extends Module implements PageBlock {
  ...
  async setData(data: ILineChartConfig) {
