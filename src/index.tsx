...
import { ILineChartConfig, callAPI, formatNumber, groupByCategory, extractUniqueTimes, concatUnique, groupArrayByKey, formatNumberByFormat, ILineChartOptions, isNumeric } from './global/index';
...
const DefaultData: ILineChartConfig = {
    ...
    const actions = [
      {
        ...
        command: (builder: any, userInputData: any) => {
          let oldData: ILineChartConfig = DefaultData;
          let oldTag = {};
          return {
            execute: async () => {
              ...
              if (advancedSchema) {
                ...
                this._data = { ...generalSettings as ILineChartConfig, options };
              }
      ...
      },
      {
        ...
        icon: 'database',
        command: (builder: any, userInputData: any) => {
          let _oldData: ILineChartConfig = DefaultData;
          return {
            execute: async () => {
              _oldData = { ...this._data };
