...
define("@scom/scom-line-chart/interface.ts", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("@scom/scom-line-chart/dts/index.ts", ["require", "exports"], function (require, exports) {
    ...
    exports.default = `/// <amd-module name="@scom/scom-line-chart/interface.ts" />
declare module "@scom/scom-line-chart/interface.ts" {
...
declare module "@scom/scom-line-chart" {
    ...
    import { ILineChartConfig, ILineChartOptions } from "@scom/scom-line-chart/interface.ts";
    interface ScomLineChartElement extends ControlElement {
        lazyLoad?: boolean;
        data: ILineChartConfig;
    }
    ...
    export default class ScomLineChart extends ScomCharts<ILineChartOptions> implements ICustomWidget {
        static create(options?: ScomLineChartElement, parent?: Container): Promise<ScomLineChart>;
        constructor(parent?: Container, options?: ScomLineChartElement);
        register(): {
            types: string;
...
define("@scom/scom-line-chart", ["require", "exports", "@ijstech/components", "@scom/scom-charts", "@scom/scom-line-chart/data.json.ts", "@scom/scom-line-chart/formSchema.ts", "@scom/scom-line-chart/dts/index.ts"], function (require, exports, components_1, scom_charts_1, data_json_1, formSchema_1, index_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let ScomLineChart = class ScomLineChart extends scom_charts_1.ScomCharts {
    ...
    ScomLineChart = __decorate([
        ...
        (0, components_1.customElements)('i-scom-line-chart', {
            icon: 'chart-line',
